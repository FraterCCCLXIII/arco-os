export const specMeta = {
  eyebrow: "Design System Spec · Draft v0.2",
  title: "One contract, every surface",
  description:
    "The Longformer design system + generative-UI architecture: a typed, themeable vocabulary an AI assembles into apps across desktop, tablet, phone, watch, and widget.",
...
export const nonNegotiables = [
  ...
  {
    title: "Themeability",
    body: "Full light / dark / custom theming via --lf-* tokens. No hardcoded values, anywhere — already the house rule.",
  },
  {
    title: "Portability",
    body: "The kit is consumed by a host app today and should drop into openclaw-os, odyssey, or openhands later without heavy build coupling.",
  },
  {
...
export const currentState = [
  {
    layer: "Tokens",
    today: "--lf-* CSS custom props, light/dark blocks, JS mirror in tokens.ts",
    verdict: "keep" as AssessmentVerdict,
    note: "Strong foundation",
  },
  {
    layer: "Styling",
    today: "CSS Modules + cx() — zero runtime cost, full theming",
    verdict: "keep" as AssessmentVerdict,
    note: "Keep as core",
  },
  {
    layer: "Primitives",
    today: "~90 components, forwardRef, token-driven",
    verdict: "keep" as AssessmentVerdict,
    note: "Needs a manifest layer",
  },
  {
    layer: "Gen-UI",
    today: "GeneratedSurfaceSchema → 59 blocks via one big switch",
    verdict: "warn" as AssessmentVerdict,
    note: "Won't scale; no runtime validation",
  },
  {
    layer: "Multi-device",
  ...
  {
    layer: "AI prompt",
    today: "Implicit — the model must \u201cknow\u201d the 59 block shapes",
    verdict: "gap" as AssessmentVerdict,
    note: "Biggest gap — no generated grammar",
  },
] as const;
...
export const decisions = [
  {
    id: "D1",
    topic: "Styling",
    title: "Tokens-first, CSS Modules core",
    oneLiner: "The AI emits schema, not CSS — Tailwind isn't the generation surface.",
    points: [
      "Keep CSS Modules + --lf-* tokens as the styling core; no Tailwind rewrite.",
  ...
  },
  {
    ...
    points: [
      "shadcn's real innovation is the copy-in registry model — exactly right for shipping Longformer blocks into host apps.",
  ...
  },
  {
    ...
    points: [
      "Primitives are themeable atoms styled with CSS Modules.",
  ...
  },
  {
    ...
    points: [
      "Replaces the implicit 59-type union and the giant render switch.",
...
export const tiers = [
  {
    tier: "Tier 0",
    name: "Tokens",
    detail: "--lf-* — color, space, radius, type, motion, z, elevation",
  },
  {
    tier: "Tier 1",
    name: "Primitives",
...
export const generationFlow = [
  ...
  {
    step: "Render",
    detail: "Each node resolves via registry[type].render into themed Longformer components.",
  },
  {
    step: "Persist",
...
export const roadmapPhases = [
  {
    ...
    summary:
      "Turn the existing 59 blocks into a real contract inside the demo — mechanical, high leverage.",
    items: [
  ...
  },
  {
    ...
    timeframe: "Demo shell + OpenClaw gateway plugin",
  ...
  },
  {
    ...
    items: [
      ...
      "Longformer registry CLI — shadcn-style installs into host apps and by the AI itself",
...
export const scorecard = [
  { label: "Versioned spec doc", status: "todo" as ScorecardStatus },
  { label: "Machine-readable schema", status: "todo" as ScorecardStatus },
...
export const primeDirective =
  "Longformer owns the shell, the design system, and the generative-UI surface. Everything else is an engine we mount — compose, don't rebuild.";
...
export const engines = [
  {
    ...
    mode: "Primary backend; serves our UI as a plugin",
  },
  {
  ...
  },
  {
    ...
    engine: "openclaw-os",
    mode: "The packaging blueprint for our shell",
  },
] as const;

export const antiBloatRules = [
  "The demo's ~50 workspaces are a design catalog, not a product backlog — the product ships the core seven.",
  "Every non-core capability is a detachable engine that lazy-loads with its workspace.",
  "One enforced dependency budget: React + lucide + the kit; new deps need a reason the registry can't cover.",
...
export const portabilityLadder = [
  ...
  { rung: "2", label: "Embedded app", detail: "Manifest + longformer-runtime npm package in any React app" },
...
export const decisionSummary = [
  ...
  { question: "Product build", decision: "Lean flagship: shell + 7 workspaces; everything else is an engine" },
