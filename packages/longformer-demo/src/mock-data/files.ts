...
export const fileFolders: Record<string, FileFolderNode> = {
  root: {
    ...
    label: "My Drive",
    items: [
      { id: "f1", name: "Product", kind: "folder", itemCount: 12, owner: { name: "Paul Bloch" }, modifiedLabel: "Jul 1" },
      { id: "f2", name: "Design", kind: "folder", itemCount: 34, owner: { name: "Dana Cho" }, modifiedLabel: "Jun 29" },
      { id: "f3", name: "Engineering", kind: "folder", itemCount: 8, owner: { name: "Marcus Webb" }, modifiedLabel: "Jun 28" },
      {
        id: "f4",
  ...
  f1: {
    ...
    label: "Product",
    items: [
      { id: "f1-1", name: "Feature specs", kind: "folder", itemCount: 5, owner: { name: "Paul Bloch" }, modifiedLabel: "Jun 30" },
      {
        id: "f1-2",
