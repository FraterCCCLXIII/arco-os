...
export interface CalendarSource {
  id: string;
  name: string;
  /** Account or provider label shown above the source, e.g. "Google" or "iCloud". */
  group: string;
...
export interface CalendarEvent {
  ...
  endTime?: string;
  tone?: CalendarEventTone;
  /** When set, the event is hidden unless its source is enabled in the sidebar. */
  sourceId?: string;
  location?: string;
...
/** Assign side-by-side columns for overlapping timed events. */
