...
import type { SocialNetworkId } from "longformer-ui-tailwind";
...
interface DemoChatWorkspaceProps {
  ...
  usage: import("longformer-ui-tailwind").UsageStats;
  ...
  typeaheadItems?: import("longformer-ui-tailwind").ComposerTypeaheadItem[];
  onTypeaheadSelect?: (item: import("longformer-ui-tailwind").ComposerTypeaheadItem) => void;
}
...
export interface WorkspaceLayoutViewModel {
  ...
  composerTypeaheadItems: import("longformer-ui-tailwind").ComposerTypeaheadItem[];
  handleTypeaheadSelect: (item: import("longformer-ui-tailwind").ComposerTypeaheadItem) => void;
  promptChips: { id: string; label: string }[];
  model: string;
  modelMenuItems: { id: string; label: string; onSelect?: () => void }[];
  demoUsage: import("longformer-ui-tailwind").UsageStats;
  ...
  activeNote: import("longformer-ui-tailwind").NotePage;
  notesGraphNodes: import("longformer-ui-tailwind").NotesGraphNode[];
  notesGraphEdges: import("longformer-ui-tailwind").NotesGraphEdge[];
  notesView: import("longformer-ui-tailwind").NotesView;
  setNotesView: (view: import("longformer-ui-tailwind").NotesView) => void;
  ...
  calendarYear: number;
  calendarView: import("longformer-ui-tailwind").CalendarView;
  setCalendarView: (view: import("longformer-ui-tailwind").CalendarView) => void;
  ...
  handleSendEmail: (draft: import("longformer-ui-tailwind").EmailDraft) => void;
...
export function buildWorkspaceWindowContent(
  ...
  viewport: import("longformer-ui-tailwind").AppPortViewport = "desktop",
): ReactNode | null {
