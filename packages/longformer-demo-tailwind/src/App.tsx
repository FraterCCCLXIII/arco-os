...
function LongformerApp() {
  ...
  function handleTypeaheadSelect(item: import("longformer-ui-tailwind").ComposerTypeaheadItem) {
    setComposerValue(item.text);
  }

  function handleAssistantTypeaheadSelect(item: import("longformer-ui-tailwind").ComposerTypeaheadItem) {
  ...
  const renderDesktopWindowContent = useCallback(
    (window: import("longformer-ui-tailwind").SurfaceWindow) => {
